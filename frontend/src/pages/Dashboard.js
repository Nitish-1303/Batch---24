...
const Dashboard = () => {
  ...
  const [stats, setStats] = useState({
    teachers: Math.floor(Math.random() * 50) + 20, // Random number between 20-70
    students: Math.floor(Math.random() * 500) + 300, // Random number between 300-800
    courses: Math.floor(Math.random() * 30) + 10, // Random number between 10-40
    departments: 4,
    complaints: Math.floor(Math.random() * 100) + 50, // Random number between 50-150
  });
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        coursesRes.data.forEach((course) => departments.add(course.department));
  ...
  if (loading) {
    return (
      <Loader
        ...
        subMessage="Please wait while we fetch your personalized dashboard..."
      />
    );
  }
  ...
  const announcements = [
    {
      ...
      date: "January 5, 2025",
      description:
        "Registration for the Spring 2025 semester is now open. Please complete your registration before January 20th.",
      branch: "CSE",
    },
    {
      ...
      date: "January 3, 2025",
      description:
        "We're upgrading our campus-wide Wi-Fi infrastructure to provide better connectivity.",
      branch: "ECE",
    },
    {
      ...
      date: "January 2, 2025",
      description:
        "Join us for an exciting series of guest lectures from industry experts starting next week.",
      branch: "MECH",
    },
  ];
  ...
  const quickLinks = [
    ...
    { title: "Submit Complaint", link: "/complaints" },
  ];
  ...
  const members = [
    {
      ...
      image: "https://res.cloudinary.com/dhdcwvoop/image/upload/v1736099165/",
      avatar: "https://res.cloudinary.com/dhdcwvoop/image/upload/v1736099165/",
              ...
              <Grid item xs={12} sm={6} md={4} key={index}>
                <StyledTeamCard>
                  <CardContent>
                    ...
                    >
                      <StyledAvatar src={member.avatar} sx={{ mb: 2 }}>
